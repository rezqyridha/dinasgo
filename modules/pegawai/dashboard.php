    ...
    $total_cair = $conn->query("SELECT SUM(REPLACE(jumlah_dana, '.', '')) AS total FROM pencairan_dana p JOIN pengajuan_perjalanan pp ON p.id_pengajuan = pp.id WHERE pp.id_pegawai = $id_pegawai")->fetch_assoc()['total'] ?? 0;
